...
CATEGORY_CHOICES = (('M','Mobile'),('L','Laptop'),('TW','Top Ware'),('BW','Bottom Ware'))
...
STATUS_CHOICES = (('Accepted','Accepted'),('Packed','Packed'),('In transit','In transit'),('Delivered','Delevered'),('Cancel','Cancel'))
